...
{
    public class InstructorCreateViewModel : IValidatableObject
    {
        public InstructorCreateViewModel()
        {
        }
        public InstructorCreateViewModel(DateTime auditCreateDateTime, DateTime auditUpdateDateTime, bool isActive, byte[] rowVersion)
        {
